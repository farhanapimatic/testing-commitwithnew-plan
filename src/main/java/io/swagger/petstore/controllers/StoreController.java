...
public class StoreController extends BaseController {
     ...
     * @return    Returns the LinkedHashMap<String, Integer> response from the API call 
     */
    public LinkedHashMap<String, Integer> getInventory(
    ) throws Throwable {
        APICallBackCatcher<LinkedHashMap<String, Integer>> callback = new APICallBackCatcher<LinkedHashMap<String, Integer>>();
        getInventoryAsync(callback);
     ...
     */
    public Order createPlaceOrder(
                final Order body
    ) throws Throwable {
        APICallBackCatcher<Order> callback = new APICallBackCatcher<Order>();
        createPlaceOrderAsync(body, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public Order getOrderById(
        ...
        APICallBackCatcher<Order> callback = new APICallBackCatcher<Order>();
        getOrderByIdAsync(orderId, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void deleteOrder(
        ...
        deleteOrderAsync(orderId, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        callback.getResult();
    }
